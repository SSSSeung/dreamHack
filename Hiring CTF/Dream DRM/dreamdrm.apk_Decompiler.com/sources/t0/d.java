...
public final class d {
    ...
    public final void a() {
        /*
            r2 = this;
            monitor-enter(r2)
            boolean r0 = r2.f5082a     // Catch:{ all -> 0x002d }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            return
        L_0x0007:
            r0 = 1
            r2.f5082a = r0     // Catch:{ all -> 0x002d }
            r2.f5084c = r0     // Catch:{ all -> 0x002d }
            t0.c r0 = r2.f5083b     // Catch:{ all -> 0x002d }
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            r1 = 0
            if (r0 == 0) goto L_0x0022
            r0.d()     // Catch:{ all -> 0x0016 }
            goto L_0x0022
        L_0x0016:
            r0 = move-exception
            monitor-enter(r2)
            r2.f5084c = r1     // Catch:{ all -> 0x001f }
        ...
        L_0x002d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: t0.d.a():void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void b(t0.c r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        L_0x0001:
            boolean r0 = r1.f5084c     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0009
            r1.wait()     // Catch:{ InterruptedException -> 0x0001 }
            goto L_0x0001
        L_0x0009:
            t0.c r0 = r1.f5083b     // Catch:{ all -> 0x001c }
            if (r0 != r2) goto L_0x000f
            monitor-exit(r1)     // Catch:{ all -> 0x001c }
            return
        L_0x000f:
            r1.f5083b = r2     // Catch:{ all -> 0x001c }
            boolean r0 = r1.f5082a     // Catch:{ all -> 0x001c }
        ...
        L_0x001c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: t0.d.b(t0.c):void");
    }
}
