...
@Metadata(
   ...
   d2 = {"Lcom/teamsa/piggybank/cash/domain/UsdcashLog;", "", "senderAccNumber", "", "receiverAccNumber", "amount", "Ljava/math/BigDecimal;", "category", "senderId", "receiverId", "transactionDate", "Ljava/time/LocalDateTime;", "id", "", "(Ljava/lang/String;Ljava/lang/String;Ljava/math/BigDecimal;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/time/LocalDateTime;J)V", "getAmount", "()Ljava/math/BigDecimal;", "getCategory", "()Ljava/lang/String;", "getId", "()J", "getReceiverAccNumber", "getReceiverId", "getSenderAccNumber", "getSenderId", "getTransactionDate", "()Ljava/time/LocalDateTime;", "piggybank"}
)
public class UsdcashLog {
   @Column(
   ...
   public UsdcashLog(@NotNull String senderAccNumber, @NotNull String receiverAccNumber, @NotNull BigDecimal amount, @NotNull String category, @NotNull String senderId, @NotNull String receiverId, @NotNull LocalDateTime transactionDate, long id) {
   ...
   // $FF: synthetic method
   public UsdcashLog(String var1, String var2, BigDecimal var3, String var4, String var5, String var6, LocalDateTime var7, long var8, int var10, DefaultConstructorMarker var11) {
      if ((var10 & 1) != 0) {
         var1 = "";
      }
