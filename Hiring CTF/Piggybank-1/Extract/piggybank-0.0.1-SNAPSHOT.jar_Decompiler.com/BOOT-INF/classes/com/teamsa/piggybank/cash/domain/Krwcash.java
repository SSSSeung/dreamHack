...
public class Krwcash {
   ...
   public Krwcash(long version, @NotNull String username, @NotNull BigDecimal balance, @NotNull String realName, @NotNull String accNumber, @NotNull String id) {
   ...
   // $FF: synthetic method
   public Krwcash(long var1, String var3, BigDecimal var4, String var5, String var6, String var7, int var8, DefaultConstructorMarker var9) {
      if ((var8 & 1) != 0) {
         var1 = 0L;
      }
      ...
      String var10;
      if ((var8 & 16) != 0) {
         var10 = UUID.randomUUID().toString();
