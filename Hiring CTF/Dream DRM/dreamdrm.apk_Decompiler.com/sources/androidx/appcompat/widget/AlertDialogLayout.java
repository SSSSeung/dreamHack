    ...
    public final void onMeasure(int i3, int i6) {
        ...
        while (true) {
            if (i12 < childCount) {
                ...
                if (view3 != null && i13 > 0) {
                    view3.measure(i11, View.MeasureSpec.makeMeasureSpec(i10 + i13, mode));
                ...
                setMeasuredDimension(View.resolveSizeAndState(getPaddingRight() + getPaddingLeft() + i15, i11, i7), View.resolveSizeAndState(paddingBottom, i6, 0));
                if (mode2 != 1073741824) {
                    ...
                    for (int i17 = 0; i17 < childCount; i17++) {
                        ...
                        if (childAt3.getVisibility() != 8) {
                            ...
                            if (f2Var.width == -1) {
                                int i18 = f2Var.height;
                                f2Var.height = childAt3.getMeasuredHeight();
